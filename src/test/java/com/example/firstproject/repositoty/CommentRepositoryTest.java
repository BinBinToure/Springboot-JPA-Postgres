...
class CommentRepositoryTest {
    ...
    void findByArticleId() {
        ...
        /* Case 3 : 9번 게시글의 모든 댓글 조회 */
        {
            ...
            List<Comment> expected = Arrays.asList();
            // 4. 비교 및 검증
            assertEquals(expected.toString(), comments.toString(), "9번 글은 없으므로 댓글 x");
        }
        /* Case 4 : 999번 게시글의 모든 댓글 조회 */
        {
            ...
            List<Comment> expected = Arrays.asList();
            // 4. 비교 및 검증
            assertEquals(expected.toString(), comments.toString(), "999번 글은 없으므로 댓글 x");
        }
        /* Case 5 : -1번 게시글의 모든 댓글 조회 */
        {
            ...
            List<Comment> expected = Arrays.asList();
            // 4. 비교 및 검증
            assertEquals(expected.toString(), comments.toString(), "-1번 글은 없으므로 댓글 x");
        }
    ...
    void findByNickname() {
        ...
        /* Case 4 : ""의 모든 댓글 조회 */
        {
            ...
            List<Comment> expected = Arrays.asList();
            // 4. 비교 및 검증
            assertEquals(expected.toString(), comments.toString(), "닉네임 공백의 댓글 조회");
        }
    }
}