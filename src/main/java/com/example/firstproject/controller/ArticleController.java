...
public class ArticleController {
    ...
    public String createArticle(ArticleForm form) {
        ...
        return "redirect:/articles/" + saved.gedId();
    }
    ...
    public String update(ArticleForm form, Model model) {
        ...
        Article target = articleRepository.findById(articleEntity.gedId()).orElse(null);
        // 2-2. 기존 데이터 값을 갱신하기
        if (target != null) {
            articleRepository.save(articleEntity);
        }
        // 3. 수정 결과 페이지로 리다이렉트하기
        return "redirect:/articles/" + articleEntity.gedId();
    }
